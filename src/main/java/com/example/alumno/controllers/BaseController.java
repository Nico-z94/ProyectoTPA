...
import com.example.alumno.services.BaseService;
...
public abstract class BaseController <DTO>{
	...
	@CrossOrigin(origins = "*")
	@Transactional
	public ResponseEntity post(@RequestBody BaseDTO dto) {
	...
	@CrossOrigin(origins = "*")
	@Transactional
	public ResponseEntity put(@PathVariable int id, @RequestBody BaseDTO dto) {
